                  ...
                  <!-- BEGIN SIDEBAR MENU -->
                    ...
                    <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="500">
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="m_ixtisaslar.html" class="nav-link ">
                                        <span class="title">Category List</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                    <a href="m_fennler.html" class="nav-link ">
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="m_movzular.html" class="nav-link ">
                                        <span class="title">Product list</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                    <a href="m_yeni_imtahan_yarat.html" class="nav-link ">
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="m_vakansiyalarin_siyahisi.html" class="nav-link ">
                                        <span class="title">orders</span>
                                    </a>
                                </li>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        <!-- BEGIN PAGE TITLE -->
                         <div class="page-title">
                            <h1>İş masası-idarəçi paneli</h1>
                            </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">İş masası-İdarəçi paneli</span>
                        </li>
                    </ul>
